/* Kidscholl theme script: branding + render dynamic lists + age tabs */
...
function setBranding() {
  ...
  document.documentElement.style.setProperty('--theme-accent', school.colors.accent ?? '#f1c40f');
...
function ensureCardLiteStyle() {
  ...
  style.textContent = `
    ...
    .card-tag{display:inline-block;padding:6px 12px;border-radius:999px;background:rgba(52,152,219,.14);border:1px solid rgba(52,152,219,.22);font-weight:900;font-size:.78rem;margin-bottom:10px}
  `;
